 ...
 * Purpose: Homework Chapter 6 problem 17,  Using Files—Hospital Report
 * Gadis 7ed http://www.m5zn.com/newuploads/2013/11/06/pdf/978d5f9ac9d682d.pdf
 * Created on July 14, 2015, 1:47 AM
 */
//system libraries
#include <iostream>
#include <fstream>
...
int main(int argc, char *argv[])
{
    ...
    if (userDec == 'I' || userDec == 'i') 
    {
        ...
        cout << endl;
        /////////////////writing to file//////////////////////////////////////
        patFile<<"In-Patient\nNumber of days spent in hospital: $"<<days<<endl;
        patFile<<"Daily rates: $"<<rate<<endl;
        patFile<<"Hospital medication charges: $"<<medChg<<endl;
        patFile<<"Hospital charges: $"<<hsChg<<endl;
        patFile<<"Patient total charges $"<<total<<endl;
        /////////////////////////////////////////////////////////////////////
    } 
    else if (userDec == 'O' || userDec == 'o')
    {
        ...
        cout<<"Patient total charges $"<<total;
        /////////////////writing to file//////////////////////////////////////
        patFile << "Out-Patient\nHospital medication charges: $"<<medChg<<endl;
        patFile << "Hospital charges: $"<<hsChg<<endl;
        patFile<< "Patient total charges $" << total<<endl;
        /////////////////////////////////////////////////////////////////////
